...
Der Make-Better Algorithmus ist eine Erweiterung der Elim Funktion. \\
...
Gelingt es, alle problematischen Knoten aus einer Farbe zu entfernen, so wird erneut Elim angewandt um die Farbe vollständig zu eliminieren. \\
