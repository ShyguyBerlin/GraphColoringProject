...
Die Erweiterung von Elim auf das Umfärben von Zusammenhangskomponenten hat gewisse Nachteile. Die Laufzeit ist um ein Vielfaches länger als bei Elim und die Färbungszahl oft nur geringfügig kleiner. \\ %oder? ich weiß nicht, was der letzte Stand da ist. - ja,
...
Es zeigt sich, dass Wigderson und Berger Rompel zwar theoretisch bessere Worst-case-Färbungen hervorbringen als die Greedy-Algorithmen, diese jedoch beim Färben von Zufallsgraphen nur selten zum tragen kommen. \\
Die greedy-Algorithmen haben im Durchschnitt deutlich kleinere Färbungszahlen geliefert. Vor allem die Färbungszahlen, die greedy-color-swaps produzierte, waren weit besser als erwartet. \\
Außerdem war überraschend, wie gut Elim die gegebenen Färbungen zuweilen noch verbessern konnte. Es war uns jedoch nicht möglich eine Formel zu finden, welche die Verbesserung der Färbungszahl durch Elim beschreibt. In unseren Tests konnten wir jedoch beobachten, dass Elim gerade schlechtere Färbungen noch stark verbessern kann. \\

Das Fazit unserer Ergebnisse ist das sollte man viele Graphen, ohne Kentnisse über besondere Eigenschaften dieser, schnell färben wollen, ist ein einfacherer Greedy-Algorythmus und eine darauf folgende Anwendung von Elim am effektivsten. \\
Sollte Laufzeit oder Rechenkraft von weniger Interesse sein kann statt greedy, greedy-color-swaps angewendet werden um noch bessere Färbungen zu erhalten.
