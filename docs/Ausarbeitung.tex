...
\begin{figure}
  \includegraphics[width=0.8\textwidth]{diagrams/greedy_pic1.png}
...
\begin{figure}
  \includegraphics[width=0.8\textwidth]{diagrams/greedy_pic2.png}
...
Die größte Verbesserung wird durch greedy-color-swap erzeugt. Allerdings ist der Algorithmus auch viel aufwändiger, vor allem bei Graphen mit hoher Kantendichte \\ %right? bin nicht mehr sicher
...
\begin{figure}
  \includegraphics[width=0.8\linewidth]{diagrams/merger_pic1.png}
...
\begin{figure}
  \includegraphics[width=0.8\linewidth]{diagrams/merger_pic2.png}
...
\begin{figure}
  \includegraphics[width=0.8\linewidth]{diagrams/merger_pic3.png}
...
\begin{figure}
  \includegraphics[width=0.8\linewidth]{diagrams/merger_pic4.png}
...
\begin{figure}
  \includegraphics[width=0.8\linewidth]{diagrams/merger_pic5.png}
...
Dabei haben wir zunächst das Ergebnis einer greedy-Färbung eines Graphen genommen und geschaut, was man verbessern könnte. \\

Dabei überprüfen wir jede einzelne Farbe, ob sie tatsächlich nötig ist, indem wir herausfinden, ob sie Problematische Knoten enthält.
