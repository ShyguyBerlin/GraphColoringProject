...
Desweiteren haben wir vier eigene Algorithmen entwickelt und diese auf die selben Eigenschaften untersucht. \\
...
noch einmal, um die Nachbarschaft vom Knoten zu ermitteln (auch  $O(n)$) %oder auch nicht, weil sich das in der NetworkX Dokumentation nicht herausfinden lässt aaaaaaaaaaaaaaaah
...
\begin{figure}
  \includegraphics[width=\stdwidth]{diagrams/new_pic1.png}
  \caption{Vergleich der neuen Ansätze}
  \label{fig:oursolvers1}
\end{figure}
\begin{figure}
  \includegraphics[width=\stdwidth]{diagrams/new_pic2.png}
...
Make-better hingegen hat gewisse Nachteile. Die Laufzeit ist um ein Vielfaches länger als bei Elim und die Färbungszahl oft nur geringfügig kleiner. \\ %oder? ich weiß nicht, was der letzte Stand da ist. - ja,
...
Es zeigt sich: sollte man viele Graphen, ohne Kenntnisse über besondere Eigenschaften dieser, schnell färben wollen, ist ein einfacherer Greedy-Algorithmus und eine darauf folgende Anwendung von Elim am effektivsten. \\
