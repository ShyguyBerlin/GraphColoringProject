...
solvers={"greedy": Solver(greedy_no_sort,[]),
         ...
         "aus_3_mach_2": Solver(aus_3_mach_2_it,[]),
         #"aus_3_mach_2_it": Solver(aus_3_mach_2_it,[]),
         "aus_3_mach_2_elim": Solver(aus_3_mach_2_elim_it,[]),
         ...
         "berger_rompel_and_elim_colors": Solver(berger_rompel_and_elim_colors,["chromatic-number"]),
         "merge_recolor_and_elim_colors": Solver(flow_and_elim_colors,[]),
